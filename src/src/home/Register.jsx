...
const title = (
    <h2 className='tittle'>Join n Day Free Workshop For <b>Advance <span>Mastering</span></b> on Sales</h2>
)
                    ...
                    <div className='col-md-6'>
                        <div className='section-wrapper'>
                            ...
                            <form className='register-form'>
                                ...
                                <input type="number" name='number' placeholder='Contact' className='reg-input' />
